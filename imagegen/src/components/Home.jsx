  ...
  return (
    <section className="max-w-7xl mx-30px-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Browse through a collection of imaginative and visually stunning images by AI Amazigh Art Generator</p>
      </div>
