...
const API_TOKEN = "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";
...
const ImageGenerationForm = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const response = await fetch(
      "https://api-inference.huggingface.co/models/Ejiji/amazighs",
      {
        method: "POST",
        headers: {
  ...
  return (<div className="imageGen">
    <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Enter a prompt to generate your own Amazigh Art:</p>
      </div>
